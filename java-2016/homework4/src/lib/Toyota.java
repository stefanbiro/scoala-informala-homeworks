...
public abstract class Toyota extends Car {
	...
	/**
	 * gear factor --> the consumption is influented also by the gear. Biggest is
	 * the gear, lowest is the fuel consumption.I assume that is specific for every brand
	 * This value  will be diffrent for every gear and he will provide diffrent consumption 
	 * in drive
	 */
	private float gearFact = 1;
	/**
	 * driveDistance --> a variable that holds the hole distance form start and stop of the car
	 */
