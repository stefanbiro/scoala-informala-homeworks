...
import ro.stefan.booking.data.loader.PeriodLoader;
import ro.stefan.booking.data.loader.RoomLoader;
import ro.stefan.booking.exception.IllegalDataForPriceException;
import ro.stefan.booking.exception.IllegalFormatInputDateException;
import ro.stefan.booking.exception.IllegalFormatStringInputException;

/**
 * This test is a cheek for a new customer for a book 
 * When he want to book a room in a period, the application check if the room is free 
...
public class TestBooking extends AbstractTestBooking {
	...
	public void init() {
		...
		for (int i = 0; i < 4; i++) {
			...
			Accommodation room2 = createNewRoom(roomLoader.roomTypes.get(i), roomFair2);
	...
	public void testPositiveBooking() {
		...
		Booking newBooking = new Booking(createNewRoom(chosenRoom, roomFair2), bookingPeriod);
