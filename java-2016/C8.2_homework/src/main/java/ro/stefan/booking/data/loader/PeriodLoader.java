...
/**
 * This class reads booking periods from files using the (chekIn,chelOut)
 * fashion All the files (.txt) are in textFiles folder in src/main/java The
 * text file is periodsToLoad.txt
 * 
 * @author stefan1
 */
