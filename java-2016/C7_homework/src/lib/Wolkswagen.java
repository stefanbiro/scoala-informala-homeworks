...
public abstract class Wolkswagen extends Car {
	...
	public Wolkswagen(float currentFuelAmmount, FuelType fuelType) {
		super(currentFuelAmmount, fuelType);
	}

	public Wolkswagen(String brand , String model, String cHASSENUMBER, FuelType fuelType, int year ,float price) {
		super(brand,model,cHASSENUMBER, fuelType, year,price);

	}
	public Wolkswagen(String brand , String model, FuelType fuelType, int year ,float price) {
